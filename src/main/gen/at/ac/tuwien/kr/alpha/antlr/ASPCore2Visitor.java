...
public interface ASPCore2Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by the {@code statement_gringoSharp}
	 * labeled alternative in {@link ASPCore2Parser#statement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitStatement_gringoSharp(ASPCore2Parser.Statement_gringoSharpContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ASPCore2Parser#heuristic}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitHeuristic(ASPCore2Parser.HeuristicContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by the {@code term_minusTerm}
	 * labeled alternative in {@link ASPCore2Parser#term}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTerm_minusTerm(ASPCore2Parser.Term_minusTermContext ctx);
	/**
	 * Visit a parse tree produced by the {@code term_binopTerm}
	 * labeled alternative in {@link ASPCore2Parser#term}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitTerm_binopTerm(ASPCore2Parser.Term_binopTermContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ASPCore2Parser#arithop}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitArithop(ASPCore2Parser.ArithopContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link ASPCore2Parser#gringo_sharp}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitGringo_sharp(ASPCore2Parser.Gringo_sharpContext ctx);
	/**
